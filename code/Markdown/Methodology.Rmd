...
I did everything in 
[`code/R/calculate.R`](./code/R/calculate.R). 
See that script for all the details.
...
I exclude municipalities with populations lower than the median, 
...
10,000, I exclude those with populations lower than the median.
...
The full cleaned dataset output by `calculate.R` is in `data/output/NJ_20132017_dive_dens.csv`. The following results come
